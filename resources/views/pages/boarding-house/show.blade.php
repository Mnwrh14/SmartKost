                    ...
                    @foreach ($room->roomImages as $image)
                        <div class="swiper-slide !w-fit">
                            <div class="flex shrink-0 w-[320px] h-[430px] overflow-hidden">
                                <img src="{{ url('storage/private/' . $image->image) }}" class="w-full h-full object-cover"
                        ...
                        @foreach ($boardingHouse->bonuses as $bonus)
                            <div
                                ...
                                <div class="flex w-[120px] h-[90px] shrink-0 rounded-[18px] bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{ url('storage/private/' . $bonus->image) }}" class="w-full h-full object-cover"
                                        alt="thumbnails">
                                </div>
                                <div>
                                    <p class="font-semibold">{{ $bonus->title }}</p>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3">
                                    <div
                                        ...
                                        <img src="{{ url('storage/private/' . $testimonial->photo) }}" class="w-full h-full object-cover"
                                            alt="icon">
                                    </div>
                                    <div>
                                        <p class="font-semibold">{{ $testimonial->name }}</p>
                                        <p class="mt-[2px] text-sm text-ngekos-grey">{{ $testimonial->date }}</p>
                                    </div>
                                </div>
