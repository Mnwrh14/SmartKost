                            ...
                            <a href="{{ route('boarding-house.show', ['slug' => $boarding->slug]) }}" class="card">
                                <div
                                    ...
                                    <div class="flex w-full h-[150px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                                        <img src="{{ url('storage/private/' . $boarding->thumbnail) }}" class="w-full h-full object-cover"
                                            alt="thumbnail">
                                    </div>
                                    <div class="flex flex-col gap-3">
                                        ...
                                        <hr class="border-[#F1F2F6]">
                                        <p class="font-semibold text-lg text-ngekos-orange">Rp {{ number_format($boarding->price, 0, ',', '.') }}<span
        ...
        <section id="Cities" class="flex flex-col p-5 gap-4 bg-[#F5F6F8] mt-[30px]">
            ...
            @forelse($cities as $city)
                ...
                <div
                    ...
                    <img src="{{ url('storage/private/' . $city->image) }}" class="w-full h-full object-cover"
                        alt="icon">
                    </div>
                    <div class="flex flex-col gap-[2px]">
