...
@section('content')
    ...
    <section id="Result" class=" relative flex flex-col gap-4 px-5 mt-5 mb-9">
        @forelse($category->boardingHouses as $boardingHouse)
        <a href="" class="card">
            <div
            ...
            <div class="flex w-[120px] h-[183px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                <img src="{{ url('storage/private/' . $boardingHouse->thumbnail) }}" class="w-full h-full object-cover" alt="{{ $boardingHouse->name }}">
            </div>
        ...
        @empty
        <p class="text-center text-ngekos-grey">Belum ada kos tersedia</p>
        @endforelse
    </section>
@endsection